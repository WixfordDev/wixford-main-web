...
export default function WhatWeDo() {
  return (
    <section className="py-24 bg-white text-black rounded-[40px] mx-4 my-10 relative z-10 overflow-hidden">
        ...
        <div className="space-y-24">
          {services.map((service, index) => (
            <div key={service.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 lg:gap-20`}>
              ...
              >
                <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-[#3b82f6] font-bold text-xl mb-4">
                  0{index + 1}
                </div>
