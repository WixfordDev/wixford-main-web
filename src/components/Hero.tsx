...
export default function Hero() {
  ...
  return (
    <section className="relative md:min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24 md:pt-32 pb-6 sm:pb-10 md:pb-16">
      {/* Glow Effect */}
      ...
      <div className="container mx-auto px-4 sm:px-6 z-10 text-center">
        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-6 sm:mb-8 backdrop-blur-sm">
           <span className="text-[#f5a623] text-sm">★</span>
           <span className="text-xs sm:text-sm font-medium text-white/90">Top-Rated Enterprise Tech Partner</span>
        </div>
        ...
        <div className="absolute top-1/3 left-[5%] sm:left-[10%] w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl rotate-12 opacity-20 blur-xl animate-pulse" />
        <div className="absolute bottom-1/4 right-[5%] sm:right-[10%] w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full opacity-20 blur-xl animate-pulse delay-700" />
      </div>
    </section>
  );
}
