...
export default function ProjectDetailsPage() {
  return (
    <div className="page-wrapper bg-[#0A0A0A] min-h-screen text-white overflow-x-hidden selection:bg-[#00B887] selection:text-white">
      ...
      {/* Reusing Global Footer but it might look odd if we want a pure dark footer transition, 
          but the design calls for "NEXT PROJECT" then end. 
          The provided code didn't include the global footer at the end, just the "Next Project" section.
          However, usually pages have a footer. I'll leave it out to match the "same too same" code provided, 
          or add it if it feels incomplete. The provided code ends with the Next Project section. 
          I will add the Footer component for consistency with other pages, but maybe simplified?
          The user said "Dark-to-Light transition layout... top hero is dark... transitioning into rounded white... containing case study".
          The "Next Project" section is dark.
          I will append the global Footer for completeness, as standard web practice.
      */}
      <GlobalFooter />
    </div>
  );
