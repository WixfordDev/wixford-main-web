...
export default function CareerPage() {
  ...
  // Custom hook or logic for text reveal could go here, or we can use motion's whileInView
  // For the specific "scroll to highlight text" effect, we can use a mask or color change based on scroll position relative to the element.
  // Since we are using motion/react, let's try a staggered reveal approach or opacity change.
  ...
  return (
    <div className="page-wrapper bg-[#0a0a0a] min-h-screen text-white selection:bg-[#3b82f6] selection:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[80vh] flex flex-col justify-center items-center text-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 px-6 mt-20">
          <nav className="flex justify-center gap-2 mb-8 text-sm text-gray-500 font-light">
            <a href="/" className="hover:text-white transition">Home</a> <span>/</span> <span className="text-white">Career</span>
          </nav>
      ...
      {/* MOTIVE SECTION (SCROLL ANIMATION) */}
        ...
        <div className="max-w-[1252px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
                ...
                <p className="text-3xl font-medium leading-tight text-gray-300">
                    {/* Simulating the reveal effect with a simple gradient text or just static for now as GSAP/SplitType integration is complex in this environment without external scripts working perfectly */}
