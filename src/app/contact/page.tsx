...
const contactFaqs = [
  {
    ...
    answer:
      "We respond to all inquiries within 24 hours on business days. For urgent projects, feel free to mention your timeline and we'll prioritize accordingly.",
  },
  {
    question: "What information should I include in my message?",
    answer:
      "Share a brief description of your project, your goals, estimated timeline, and any relevant links or references. The more context you provide, the more specific and helpful our response will be.",
  },
  {
    question: "Do you offer free consultations?",
    answer:
      "Yes. We offer a complimentary 30-minute discovery call for all new project inquiries. This gives us a chance to understand your needs and determine how we can best help.",
  },
  {
    question: "What happens after I submit the contact form?",
    answer:
      "Our team reviews your submission and reaches out within 24 hours to confirm receipt and schedule an initial discovery call. From there, we'll outline next steps and a proposed timeline.",
  },
  {
    question: "Can I schedule a call directly?",
    answer:
      "Yes. After submitting the form, you'll receive a link to book a call at a time that suits you. Alternatively, mention your preferred time in the message and we'll coordinate directly.",
  },
];
      ...
      <section className="relative pt-32 pb-20 text-center">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold leading-tight">
            Initiate Your <br />
            <span className="text-[#60a5fa] italic font-display font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-12">
            <h2 className="text-4xl font-bold">
              ...
              <span className="text-[#3b82f6] italic font-display">
                Requirements
              </span>
            </h2>
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-gray-400">
                <span className="text-green-400">✔</span> Guaranteed response
                within 24 hours
              </div>
              <div className="flex items-center gap-3 text-gray-400">
                <span className="text-green-400">✔</span> Strict NDA & IP
                Protection
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-white/10 p-6 sm:p-8 md:p-10 rounded-[28px] sm:rounded-[40px] backdrop-blur-md">
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <input
                    ...
                    name="budget"
                    id="b1"
                    className="hidden budget-radio"
                  />
                  <label
                    htmlFor="b1"
                    className="px-4 py-2 border border-white/10 rounded-full text-sm cursor-pointer hover:border-[#3b82f6] transition text-gray-400"
                  >
                    Less than $5k
                  </label>
              ...
              <button className="w-full py-4 bg-[#3b82f6] rounded-2xl font-bold hover:bg-[#2563eb] transition flex justify-center items-center gap-3 shadow-lg shadow-blue-500/20">
                Submit Inquiry{" "}
                <img
                  src="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67adba6a3ab018a0349e2bc2_CTA%20Arrow%20(2).svg"
                  className="w-4"
                  alt="Arrow"
                />
              </button>
      ...
      <section className="border-t border-white/5 py-24">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 text-center">
          ...
          >
            ...
            <div className="text-lg sm:text-2xl font-bold group-hover:text-[#60a5fa] transition break-all">
              contact@wixford.com
            </div>
          </div>
          <div
